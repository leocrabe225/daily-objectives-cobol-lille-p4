...
- [x] Écrire un programme qui demande à l'utilisateur de saisir trois nombres, puis qui affiche le plus grand des trois.
...
- [x] Demander à l'utilisateur de saisir un mot, puis inverser ce mot et afficher le résultat.
...
- [x] Demander à l'utilisateur de saisir une année et vérifier si elle est bissextile.
...
- [x] Écrire un programme qui calcule la conjecture de Syracuse à partir d’un nombre entier non nul saisi par l’utilisateur, jusqu’à ce que ce nombre atteigne 1.
...
- [x] Demander à l'utilisateur de saisir deux nombres entiers positifs, puis calculer et afficher leur PGCD en utilisant l'algorithme d'Euclide.
